...
export default function UpdateMileageForm({
  chosenVehicle,
  setChosenVehicle,
  setErrors,
  user,
  ...
  return (
    <Container maxWidth="xs">
      ...
      >
        ...
        <Typography variant="body2">Vin: {chosenVehicle.vin}</Typography>
        <Typography variant="body2">Mileage: {fixedMiles}</Typography>
