...
@Entity
@Table(name = "maint_cost", uniqueConstraints = @UniqueConstraint(columnNames = {"vehicle_type_id", "maint_title"}))
public class MaintCost {
    ...
    public MaintCost(Long maintCostId, VehicleType vehicleTypeId, String maintTitle, String maintDesc,
                     Integer independentAvg, Integer independentHigh, Integer independentLow, Integer dealerAvg,
                     Integer dealerHigh, Integer dealerLow) {
