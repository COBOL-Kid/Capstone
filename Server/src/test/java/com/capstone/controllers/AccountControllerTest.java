...
class AccountControllerTest {
  ...
  void shouldRequireAuthentication() {
    ...
    assertEquals(
        ...
        controller
            .updateProfile(
                null, new UpdateAccountRequest("Pat", "Driver", "driver@example.com", null))
            .getStatusCode());
    assertEquals(
        HttpStatus.UNAUTHORIZED,
        controller
  ...
  void shouldChangePasswordAndDeleteAccount() {
    ...
    assertEquals(
        HttpStatus.NO_CONTENT, controller.changePassword(user, passwordRequest).getStatusCode());
    assertEquals(
        HttpStatus.NO_CONTENT, controller.deleteAccount(user, deleteRequest).getStatusCode());
