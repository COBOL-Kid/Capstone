...
class RecallControllerTest {
    ...
    void shouldRequireAuthentication() {
        ...
        assertEquals(HttpStatus.UNAUTHORIZED, controller.getCompletedRecalls(null, "JTENU5JR6M5962554").getStatusCode());
        assertEquals(HttpStatus.UNAUTHORIZED,
                controller.completeRecall(null, new CompleteRecallRequest("JTENU5JR6M5962554", 22L, null, null, null,
                        null)).getStatusCode());
    }
    ...
    private CompletedRecallResponse completedRecall() {
        return new CompletedRecallResponse(55L, "JTENU5JR6M5962554", 22L, LocalDate.of(2025, 4, 6),
