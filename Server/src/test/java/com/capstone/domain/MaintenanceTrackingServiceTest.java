...
class MaintenanceTrackingServiceTest {
    ...
    void shouldReturnExistingCompletedMaintenanceWithoutSavingDuplicate() {
        ...
        UserVin userVin = userVin(45000);
        MaintMileage maintMileage = maintMileage();
        CompletedMaintenance existing = new CompletedMaintenance(99L, userVin, maintMileage,
                LocalDate.of(2025, 1, 2), 44000, null, "Already done");
        CompleteMaintenanceRequest request = new CompleteMaintenanceRequest("JTENU5JR6M5962554", 11L,
    ...
    void shouldRejectMissingMaintenanceItem() {
        MaintenanceTrackingService service = new MaintenanceTrackingService(mock(CompletedMaintenanceRepositoryJPA.class),
                mock(MaintMileageRepositoryJPA.class), mock(UserVinRepositoryJPA.class));
