...
class RecallTrackingServiceTest {
	...
	void shouldReturnExistingCompletedRecallWithoutSavingDuplicate() {
		...
		UserVin userVin = userVin();
		Recall recall = recall();
		CompletedRecall existing = new CompletedRecall(55L, userVin, recall, LocalDate.of(2025, 3, 4), "Toyota dealer",
				0.0, "Already closed");
		CompleteRecallRequest request = new CompleteRecallRequest("JTENU5JR6M5962554", 22L, LocalDate.of(2025, 4, 6),
				"Other shop", 25.0, "Duplicate request");
	...
	private Recall recall() {
		return new Recall(22L, vehicleType(), "22V480000", "", LocalDate.of(2022, 6, 7), "EQUIPMENT:OTHER:LABELS",
				"Summary", "Consequence", "Remedy", "Notes", "Southeast Toyota Distributors, LLC");
	}
