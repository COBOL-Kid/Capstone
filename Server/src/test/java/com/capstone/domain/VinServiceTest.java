...
class VinServiceTest {
    ...
    void shouldDelegateFindVinsByUserId() {
        ...
        assertEquals("https://api.auto.dev/photos/retail/JTENU5JR6M5962554-1.jpg", responses.getFirst()
                .selectedImageUrl());
    }
    ...
    void shouldUpdateSelectedImageWhenUrlIsAvailable() {
        ...
        assertEquals("https://api.auto.dev/photos/retail/JTENU5JR6M5962554-2.jpg", response.get()
                .selectedImageUrl());
    }
